...
export function ProductGrid() {
  ...
  return (
    <section id="products" className="relative overflow-hidden bg-slate-950 py-24 sm:py-32">
      {/* Background ambient glow */}
      <div className="pointer-events-none absolute left-1/2 top-1/2 -z-10 h-[600px] w-[600px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-amber-500/5 blur-[100px]" />
...
function TiltCard({ product }: { product: Product }) {
  ...
  return (
    <motion.div
      ...
      className="group relative flex flex-col justify-between rounded-2xl border border-slate-800/80 bg-slate-900/80 p-6 shadow-2xl backdrop-blur-xl transition-colors hover:border-amber-500/50"
    >
      ...
      <div
        ...
        className="relative mb-6 flex aspect-video w-full items-center justify-center overflow-hidden rounded-xl border border-slate-800/50 bg-slate-950/60 p-4"
      >
        <motion.div
          animate={{ y: [0, -8, 0] }}
      ...
      <div style={{ transform: "translateZ(30px)" }}>
        ...
        <h3 className="mt-1 text-lg font-bold text-white transition-colors group-hover:text-amber-400">
          {product.title}
        </h3>
